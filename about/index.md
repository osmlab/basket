...
Basket is maintained by the OSM Institutions community of practice, whose members include {% for author in site.data.authors %}{{ author.name | markdownify }}{% if forloop.last == false %}, {% else %} and {% endif %}{% endfor %}. 
